...
<head>
    ...
    <title> Receita  - {{ date('d-m-Y') }}</title>
    <style>
        #footer {
            padding-top: 10px;
            padding-bottom: 0px;
...
<center> <img class="img-center" src="dashboard/img/hospital.png" alt="" width="80"></center>
        ...
        <h4  class="text-center" >Receita</h4>


    </header>

    <section class="col-12">
        <b> Data </b> {{$prescription->created_at}}  <br>
        <b> Código da Consulta: {{$prescription->id}} </b>       <br>

         <b> Nome do Paciente</b> :<br> <b> Idade</b> : {{$prescription->Patients->age}}<br> <br> <br>
         <b>    Receita:
...
_____________________________________<br>
    <b> {{$prescription->Doctors->name }}:</b></div>
