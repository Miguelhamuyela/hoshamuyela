                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 col-md-8">
                        <div class="invoices-tabs">
                            <ul>
                                <li>
                                    <a href="{{ route('admin.trans_payment_academic_years.index') }}" class="active">Lista de
                                        Pagamento</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.trans_payment_academic_years.index') }}" class="active">Novo
                    ...
                    <form data-select2-id="8">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms ">
                                    <label>
                                        <span class="login-danger"></span>Detalhes de Pagamento</label>
                                    <input required
                                        value="{{ isset($payment_academic_years->paymentDescription) ? $payment_academic_years->paymentDetails : old('paymentDetails') }}"
                                        name="paymentDetails" class="form-control" type="text" placeholder="" />
                                </div>
                            </div>
                            <div class="col-12">
                                <br>
