...
<div class="col-md-12">
    <div class="form-group">
        ...
        <input type="text" name="name" id="name" value="{{ isset($gallery->name) ? $gallery->name : old('name') }}"
            class="form-control " placeholder="Titulo da Galeria" required>
    </div>
</div> <!-- /.col -->

<div class="col-md-12">
    <div class="form-group">
        <label for="image">Selecione a Capa</label>
