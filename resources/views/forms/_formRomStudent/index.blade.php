                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8 col-md-8">
                            <div class="invoices-tabs">
                                <ul>
                                    <li>
                                        <a href="#" class="active">Adicionar Novo Dormitório</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.student_rooms.index') }}" class="active">Clica aqui
                                            para a Lista dos Dormitórios</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms ">
                                        <label>Seccção de Dormitório
                                            <span class="login-danger"></span></label>
                                        <input class="form-control " name="section"type="text" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>O Nome do Responsavel do Dormitório
                                            <span class="login-danger"></span></label>
                                        <input type="text" name="headRoom"class="form-control" />
                                    </div>
                                </div>
                                <div class="col-12 col-sm-8">
                                    <div class="form-group local-forms">
                                        <label>Estado do Dormitório
                                            <span class="login-danger"></span></label>
                                        <input type="text" name="RoomState"class="form-control" />
                                    </div>
                                </div>
                                <div class="col-12">
