                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8 col-md-8">
                            <div class="invoices-tabs">
                                <ul>
                                    <li>
                                        <a href="{{ route('admin.teacher_classes.create') }}" class="active">Adicionar o
                                            Estudante</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.teacher_classes.index') }}" class="active">Estudante
                                            Adicionado
                                            Numa Turma</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.teacher_classes.report') }}" class="active">Imprimir a
                                            Turma</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-8">
                                    <div class="form-group local-forms">
                                        <label>Periódo de Aula
                                            <span class="login-danger"></span></label>
                                        <select
                                            value="{{ isset($period->period) ? $teachers->period : old('period') }} "name="period"
                                ...
                                <div class="col-md-12">
                                    <textarea required rows="5" cols="5" name="obs"class="form-control"
                                        placeholder="Descrição sobre o Ano Lectivo"></textarea>
                                </div>
                                <div class="col-12">
                                    <br><br>
