...
@section('content')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form action="{{ route('admin.student_classes_seach') }}"method="post">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="invoices-tabs">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route("admin.student_classes.create") }}" class="active">Adicionar  Estudante Numa Turma</a>
                                        </li>
                                        <li>
                                ...
                                <table class="table table-stripped table-hover datatable">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Curso</th>
                                            <th>Turma</th>
                                            <th>Hora <br>de Entrada</th>
                                            <th>Hora <br>de Saída</th>
                                            <th>Periódo</th>
                                            <th class="text-end">Ação</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($student_classes as $item)
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.student_classes.edit', $item->id) }}"><i
                                                                    class="far fa-edit me-2"></i>Editar</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.student_classes.show', $item->id) }}"><i
                                                                    class="far fa-eye me-2"></i>Detalhes</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.student_classes.delete', $item->id) }}"><i
