                                ...
                                <div class="card-body">
                                    ...
                                    <div class="personal-activity">
                                        ...
                                        <div class="views-personal">
                                            <h4>Email</h4>
                                            <h5>
                                                <a href="https://preschool.dreamguystech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="81e5e0e8f2f8c1e6ece0e8edafe2eeec">[email&#160;protected]</a
                  >
                </h5>
              </div>
            </div>
            ...
            <div class="skill-blk">
              <div class="skill-statistics">
                ...
                <div class="progress mb-0">
                  <div
                    class="progress-bar bg-photoshop"
                    role="progressbar"
                    style="width: 90%"
                    aria-valuenow="90"
                    aria-valuemin="0"
              ...
              <div class="skill-statistics mb-0">
                ...
                <div class="progress mb-0">
                  <div
                    class="progress-bar bg-illustrator"
                    role="progressbar"
                    style="width: 95%"
                    aria-valuenow="95"
                    aria-valuemin="0"
