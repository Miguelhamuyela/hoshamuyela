...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form action="{{ route('admin.finalist_academic_years_seach') }}"method="post">
                        ...
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <form action="{{ route('admin.finalist_academic_years.print.show') }}"
                                                    method="post">
                                                    @csrf
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('admin.finalist_academic_years.create') }}"
                                            class="btn btn-outline-primary me-2"><i class=""></i> Adicionar
                                            Novo Finalista</a>
                                        <a href="{{ route('admin.finalist_academic_years.create') }}"
                            ...
                            <div class="table-responsive">
                                <table
                                    ...
                                    <tbody>
                                        @foreach ($finalist_academic_years as $item)
                                            <tr>
                                                <td>{{ $item->id }}</td>
                                                <td>{{ $item->students->name }}</td>
                                                <td>{{ $item->courses->courseName }}</td>
                                                <td>{{ $item->aproveitaments->aproveitamentsName }}</td>
                                                <td>{{ $item->parish }}</td>
