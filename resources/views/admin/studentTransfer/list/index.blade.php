...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <form action="{{ route('admin.student_transfers_seach') }}"method="post">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="invoices-tabs">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.student_transfers.create') }}" class="active">Adicionar
                                            Nova Trnsferência</a>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <form action="{{ route('admin.student_transfers.print') }}"
                                                    method="post">
                                                    @csrf
                            ...
                            <table class="table table-stripped table-hover datatable">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th>Curso</th>
                                        <th>Quarto</th>
                                        <th>Número<br>de Cama </th>
                                        <th>Tipo<br>Estudante</th>
                                        <th>Causa<br> ou Motivo</th>
                                ...
                                <tbody>
                                    @foreach ($student_transfers as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->transfers->nameTransfer }}</td>
