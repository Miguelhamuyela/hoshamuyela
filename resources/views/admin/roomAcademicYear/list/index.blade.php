...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form action="{{ route('admin.room_academic_years_seach') }}"method="post">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="invoices-tabs">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('admin.room_academic_years.create') }}"
                                                class="active">Adicionar
                                                Novo Estudante no Dormitório </a>
                                        </li>
                                        <li>
                                            ...
                                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{ route('admin.room_academic_years.print') }}"
                                                        method="post">
                                                        @csrf
                                ...
                                <table class="table table-stripped table-hover datatable">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Telefone</th>
                                            <th>Secção</th>
                                            <th>Responsavel do<br> Quarto</th>
                                                    ...
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.room_academic_years.edit', $item->id) }}"><i
                                                                    class="far fa-edit me-2"></i>Editar</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.room_academic_years.show', $item->id) }}"><i
                                                                    class="far fa-eye me-2"></i>Detalhes</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.room_academic_years.delete', $item->id) }}"><i
