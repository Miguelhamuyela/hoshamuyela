...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        $response['students'] = Student::orderBy('id', 'ASC')->get();
        //Logger
    ...
    {
        return redirect("admin/estudantes/seachResult/{$request->name}");
    }
    ...
    public function students_seach(Request $request)
    {
    ...
    {
        $response['students'] = Student::with('procinces', 'courses')->get();
        //Logger
    ...
    //   $response['students'] = Student::with('procinces','courses')->find($id);
    //  return view('admin.students.details.index', $response);
    ...
    public function edit($id)
    {
        ...
        //Logger
       // $this->Logger->log('info', 'Entrou em editar um Estudante com o identificador ' . $id);
        $response['courses'] = Course::get();
        $response['municipies'] = Municipe::get();
        $response['provinces'] = Province::get();
        $response['academic_years'] = AcademicYear::get();

        $this->Logger->log('info', 'Editar o Estudante');
    ...
    //    return redirect()->back()->with('destroy', '1');
        ...
        return  redirect()->route('admin.students.index')->with('destroy', '1');
